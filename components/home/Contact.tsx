...
const Contact = () => {
  return (
    <section className="pt-20 py-40 px-4 sm:px-8 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-12 items-start">
          ...
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-medium text-primary leading-tight mb-10">
          ...
          <div className="w-full h-80 sm:h-95 lg:h-105 rounded-lg overflow-hidden">
